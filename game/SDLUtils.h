...
enum UIAction{NO_ACTION, A, B, C , CHANGESTATE_GAMEPLAY, CHANGESTATE_STAGESELECT, QUIT, LOADLEVEL_CASTLE, LOADLEVEL_PLANES, LOADLEVEL_BRIDGE, LOADLEVEL_ARENA, PAUSE_RESUME, PAUSE_MAINMENU, PAUSE_QUITGAME};
